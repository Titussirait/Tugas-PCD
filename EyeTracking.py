# -*- coding: utf-8 -*-
"""
Created on Wed Nov  6 08:22:42 2024
...
detect_face = True
image = cv2.imread("C:/Users/Lenovo/Pictures/Camera Roll/WIN_20241027_13_30_06_Pro.jpg")
print (image.shape)
...
cv2.imshow("output", image_resize(image, height=600))
cv2.waitKey()
